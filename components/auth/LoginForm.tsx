...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error.code === 'auth/user-not-found') {
        ...
        console.log('Firebase auth not enabled, using demo login');
  ...
  const handleDemoLogin = async () => {
    setEmail('demo@healthmate.com');
    setPassword('demo123456');
    setIsLoading(true);
    
    try {
      await signIn('demo@healthmate.com', 'demo123456');
      toast.success('Welcome to HealthMate! 🎉');
      router.push('/dashboard');
    } catch (error: any) {
      ...
      if (error.code === 'auth/operation-not-allowed') {
        ...
        toast.error('Demo login failed. Please try with your own account.');
      }
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-4">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-purple-200 text-lg">Your AI-Powered Health Companion</p>
          </motion.div>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-4 py-4 bg-white/10 border rounded-xl text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 ${
              ...
              <div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-12 py-4 bg-white/10 border rounded-xl text-white placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 ${
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="w-full py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Try Demo Account
              </motion.button>
            </form>
          ...
          >
            <h3 className="text-blue-200 font-semibold mb-2">To Enable Real Authentication:</h3>
